...
//add by zhaopenglin for set default theme 20160418 start
import com.android.launcher3.ragentek.config.RGKGeneralConfig;
import android.provider.Settings;
//add by zhaopenglin for set default theme 20160418  end
...
public class Launcher extends Activity
    ...
    private static final String IS_THE_FIRST_BOOT = "is_the_first_boot"; //add by zhaopenglin for set default theme 20160418
    ...
    private boolean mWallpaperButtonEnable = true;
    ///M.

    private boolean isSortByInstalltime = false;//Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426
    private boolean isSortByTopPackage = false;//Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///M: ALPS02275072, refersh InvariantDeviceProfile
        ...
        /**@}**/
        //Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(start)
        isSortByInstalltime = getResources().getBoolean(R.bool.is_sort_by_installtime);
        isSortByTopPackage = getResources().getBoolean(R.bool.is_sort_by_toppackage);
        if(isSortByInstalltime) Log.i(TAG,"Sort by installtime");
        if(isSortByTopPackage) Log.i(TAG,"Sort by topPackages");
        //Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(end)
        ...
        //sync BUG_ID:DLLEE-890 zhaopenglin 20160308(start)
        ...
        //sync BUG_ID:DLLEE-890 zhaopenglin 20160308(end)
    ...
    //Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(start)
    public boolean getIsSortByInstalltime(){
        return isSortByInstalltime;
    }
    public boolean getIsSortByTopPackage(){
        return isSortByTopPackage;
    }
    //Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(end)
    /**
    ...
    private void handleActivityResult(
        ...
        /// M: [ALPS01475192] Need to add this app widget item
        /// into sPendingAddList if workspace is locked to
        /// fix ALPS01382035 and ALPS01432963.
    ...
    @Thunk void completeTwoStageWidgetDrop(final int resultCode, final int appWidgetId) {
        ///M. ALPS02202279, Check null pointer.
    ...
    protected void onResume() {
        ...
        if (Settings.System.getInt(getContentResolver(), IS_THE_FIRST_BOOT, 1) == 1
                &&  getResources().getBoolean(R.bool.set_default_theme)
                &&"1".equals(android.os.SystemProperties.get("ro.rgk_theme_support"))) {
            Settings.System.putString(getContentResolver(), "theme_switch_name", "Glitz");
            Intent intent = new Intent(RGKGeneralConfig.THEME_ACTION);
            sendBroadcast(intent);
            Settings.System.putInt(getContentResolver(), IS_THE_FIRST_BOOT, 0);
        }
      //add by zhaopenglin for set default theme 20160418 end
    }
   ...
   //Add by zhaopenglin 20160121(start)
   public void onClickThemeChangeButton(View v){
    ...
    //Add by zhaopenglin 20160121(end)
    ...
    @Thunk void completeAddAppWidget(int appWidgetId, long container, long screenId,
        ...
        if (!mRestoring) {
            ...
            /// M:ALPS02393519, Null pointer exception {@
            if (mWorkspace != null) {
                mWorkspace.addInScreen(launcherInfo.hostView, container, screenId, info.cellX,
                 ...
                 LauncherLog.d(TAG, "error , mWorkspace = null");
             }
            /// @}
    ...
    protected void onClickSettingsButton(View v) {
        ...
        //Add BUG_ID:DWLEBM-226 zhaopenglin 20160408 start
        if(getResources().getBoolean(R.bool.is_enter_settings)){
        ...
        //Add BUG_ID:DWLEBM-226 zhaopenglin 20160408 end
        if (mLauncherCallbacks != null) {
    ...
    public boolean onLongClick(View v) {
        ...
        if (isWorkspaceLocked()) {
            LauncherLog.d(TAG, "onLongClick: isWorkspaceLocked() mWorkspaceLoading "
    ...
    // M: Optimize the search box UI display in layout-sw600dp-land @{
    public boolean isSmallLandTablet() {
        return getResources().getBoolean(R.bool.is_tablet)
                && getResources().getBoolean(R.bool.config_land)
                && !getResources().getBoolean(R.bool.is_large_tablet);
    }
    // }@

    private boolean needToUpdateQsb() {
        AppWidgetProviderInfo searchProvider = Utilities.getSearchWidgetProvider(this);
        if (searchProvider == null || mCurrentQsbPkgName == null) {
            return false;
        }
        boolean ret = !mCurrentQsbPkgName.equals(searchProvider.provider.getPackageName());
        LauncherLog.d(TAG, "needToUpdateQsb = " + ret + ", mCurrentQsbPkgName = "
                + mCurrentQsbPkgName);
        return ret;
    }
    ...
    public View getOrCreateQsbBar() {
        ...
        if (mQsb == null) {
            ...
            mCurrentQsbPkgName = searchProvider.provider.getPackageName();
            LauncherLog.d(TAG, "getOrCreateQsbBar, mCurrentQsbPkgName = " + mCurrentQsbPkgName);
    ...
    @Thunk class CloseSystemDialogsIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            ///M:ALPS02429817, if close system dialogs as keyguard lock, don't call
            /// setWaitingForResult(false) which lead to RUNTIME_STATE_PENDING_ADD_CONTAINER
            // isn't saved. {@
    ...
    public void bindAllApplications(final ArrayList<AppInfo> apps) {
       ...
       if (waitUntilResume(mBindAllApplicationsRunnable, true)) {
        ...
        if (mUnreadLoadCompleted) {
            // unread AppsCustomizePagedView.updateUnreadNumInAppInfo(apps);
        }
        /**@}**/
    }
   ...
   /**
    ...
    //Add BUG_ID:DWYQLSSB-302 zhaopenglin 20160705(start)
    @Override
    public void showWorkspace() {
        // TODO Auto-generated method stub
        showWorkspace(false);
    }
    //Add BUG_ID:DWYQLSSB-302 zhaopenglin 20160705(end)
}
