...
public class ShortcutAndWidgetContainer extends ViewGroup {
    ...
    //A: chenlong.guo for FolderAnimation (Start)
	...
	//A: chenlong.guo for FolderAnimation (End)
    ...
    public void measureChild(View child) {
        ...
        if (!lp.isFullscreen) {
            ...
            if (child instanceof LauncherAppWidgetHostView) {
                ...
                int cellPaddingY = (int) Math.max(0, ((lp.height - cHeight) / 6f));//Modify "2f" to "6f" by zhaopenglin 20160311  DWYQLSSMY-31
