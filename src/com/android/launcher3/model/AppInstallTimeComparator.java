 ...
 * <p>
 * Used to sort application install time in all apps view and widget tray view.
 */
public class AppInstallTimeComparator {
        ...
        mAppInfoComparator = new AbstractUserComparator<ItemInfo>(context) {
            ...
            public final int compare(ItemInfo a, ItemInfo b) {
                ...
                if (a instanceof AppInfo && b instanceof AppInfo) {
                    ...
                    result = compareInstallTime(aAppInfo.getFirstInstallTime(), bAppInfo.getFirstInstallTime());
    ...
    /**
     * Returns a locale-aware comparator that will installtime order a list of applications.
     */
    public Comparator<ItemInfo> getAppInstallTimeComparator() {
    ...
    @Thunk int compareInstallTime(Long installTimgeA, Long installTimgeB) {
         if(installTimgeA > installTimgeB) return 1;
         else return -1;
    }
}
