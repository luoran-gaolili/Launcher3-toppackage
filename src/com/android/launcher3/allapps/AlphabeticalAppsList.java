...
import com.android.launcher3.model.AppInstallTimeComparator;
import com.android.launcher3.AllAppsListPluginEx;
...
public class AlphabeticalAppsList {
    ...
    private boolean isSortByInstalltime;
    private boolean isSortByTopPackage;
    //Add BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(end)
    ...
    public AlphabeticalAppsList(Context context) {
        ...
        //Modify BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(start)
        //mAppNameComparator = new AppNameComparator(context);
        isSortByInstalltime = mLauncher.getIsSortByInstalltime();
        isSortByTopPackage = mLauncher.getIsSortByTopPackage();
        if( isSortByInstalltime ){
            mAppInstallTimeComparator= new AppInstallTimeComparator(context);
        }else{
            mAppNameComparator = new AppNameComparator(context);
        }
        //Modify BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(end)
    }
    ...
    private void onAppsUpdated() {
        ...
        if(isSortByTopPackage){
            AllAppsListPluginEx.reorderApplist(mApps);
            for (AppInfo appInfo : mApps) {
                Log.i(TAG,"after top sort :"+appInfo.componentName.getClassName());
            }
        }
        //Modify BUG_ID:DWYQLSSMY-373 zhaopenglin 20160426(end)
