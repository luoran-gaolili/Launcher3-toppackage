...
public class DeviceProfile {
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
        ...
        //Add BUG_ID:DWYQLSSMY-952 zhaopenglin 20160511(start)
        if( res.getBoolean(R.bool.is_hdpi))
            iconTextSizePx = iconTextSizePx < 19? iconTextSizePx :
            (iconTextSizePx < 20 ? iconTextSizePx - 1:(int)(iconTextSizePx * 0.91));
        //Add BUG_ID:DWYQLSSMY-952 zhaopenglin 20160511(end)
        ...
        folderCellHeightPx = cellHeightPx + edgeMarginPx + 20;//add 30 by zhaopenglin for icon in folder 20160311
